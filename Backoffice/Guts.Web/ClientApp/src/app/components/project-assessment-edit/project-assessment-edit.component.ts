...
export class ProjectAssessmentEditComponent {
  ...
  ngOnInit() {
    ...
    this.editAssessmentForm
      .get("description")
      .setValue(this.projectAssessment.description);
    this.editAssessmentForm
      .get("openOn")
      .setValue(this.projectAssessment.openOnUtc);
    this.editAssessmentForm
      .get("deadline")
      .setValue(this.projectAssessment.deadlineUtc);
  }
      ...
      .subscribe((result: PostResult) => {
        ...
        if (result.success) {
          ...
          this.toastr.error(
            ...
            "Could not update project assessment",
          );
        }
