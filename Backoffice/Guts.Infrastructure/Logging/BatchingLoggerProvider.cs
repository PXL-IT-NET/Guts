...
{
    /// <summary>
    /// Abstract provider that writes logs to a concurrent collection and flushes batches of logs to the backing store (e.g. a file)
    /// This all happens in a background thread.
    /// </summary>
