...
namespace Guts.Infrastructure.Migrations
{
    ...
    [Migration("20260829144233_SyncTopicsDiscriminatorColumnType")]
    partial class SyncTopicsDiscriminatorColumnType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Guts.Domain.ProjectTeamAssessmentAggregate.PeerAssessment", b =>
                {
                    ...
                    b.HasIndex("ProjectTeamAssessmentId", "UserId", "SubjectId")
                        .IsUnique();
