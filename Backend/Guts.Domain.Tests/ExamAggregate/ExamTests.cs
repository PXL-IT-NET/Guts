...
namespace Guts.Domain.Tests.ExamAggregate
{
    public class ExamTests
    {
        ...
        [Test]
        public void AddExamPart_ShouldThrowContractExceptionOnDeadlineInThePast()
        {
            var validName = _random.NextString();
            var invalidDeadline = DateTime.UtcNow.AddDays(-1);
            Assert.That(() => _existingExam.AddExamPart(validName, invalidDeadline), 
