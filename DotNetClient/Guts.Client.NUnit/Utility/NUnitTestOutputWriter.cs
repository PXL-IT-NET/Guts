...
internal class NUnitTestOutputWriter : ITestOutputWriter
{
    private static NUnitTestOutputWriter? _instance;

    public static ITestOutputWriter Instance => _instance ??= new NUnitTestOutputWriter();
